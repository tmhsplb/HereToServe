...
$("#dashboardGrid").jqGrid({
    ...
    colModel: [
        ...
        { key: false, align: 'center', name: 'Expiry', index: 'Expiry', formatter: 'date', width: 130, editable: true, sortable: true, search: false },
       ...
       // { key: false, align: 'center', name: 'DOB', index: 'DOB', formatter: 'date', width: 120, editable: true, sortable: true, search: false },
        { key: false, align: 'center', name: 'sDOB', index: 'sDOB', width: 124, editable: true, sortable: true, search: true },
        { key: false, align: 'center', name: 'Age', index: 'Age', width: 55, editable: false, sortable: true, search: false },
        { name: 'ACK', index: 'ACK', align: 'center', width: 57, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
        { name: 'LCK', index: 'LCK', align: 'center', width: 55, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
        { name: 'XID', index: 'XID', align: 'center', width: 52, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
        { name: 'XBC', index: 'XBC', align: 'center', width: 54, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
