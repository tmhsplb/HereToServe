...
$("#dashboardGrid").jqGrid({
    ...
    colModel: [
        ...
        { key: false, align: 'center', name: 'Age', index: 'Age', width: 58, editable: false, sortable: true, search: false },
        { name: 'ACK', index: 'ACK', align: 'center', width: 59, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
        { name: 'LCK', index: 'LCK', align: 'center', width: 58, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
        { name: 'XID', index: 'XID', align: 'center', width: 55, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
        { name: 'XBC', index: 'XBC', align: 'center', width: 55, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
