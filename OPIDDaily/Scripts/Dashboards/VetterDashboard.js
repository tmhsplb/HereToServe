...
$("#dashboardGrid").jqGrid({
    ...
    pageable: true,
    mtype: "Get",
    colNames: ['Id', 'CM', 'Agency', 'Expires', 'Stage', 'C', 'H', 'Last Name', 'First Name', 'Middle Name', 'Birth Name', 'DOB', 'Age', 'ACK', 'LCK', 'XID', 'XBC', 'WBM', 'MSG', 'Notes'],
    colModel: [
       ...
       // { key: false, align: 'center', name: 'DOB', index: 'DOB', formatter: 'date', width: 120, editable: true, sortable: true, search: false },
        ...
        { name: 'WBM', index: 'WBM', align: 'center', width: 50, editable: true, edittype: "checkbox", editoptions: { value: "Y:''" }, search: false },
